...
import com.zerobase.zb_midterm_project01_final.dtos.LocalPublicWifiDetailInfo;
import com.zerobase.zb_midterm_project01_final.dtos.TbPublicWifiInfo;
...
public class SaveMyPositionServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        // 요청받는 데이터를 DB에 저장함.
        PublicWifiService.PositionDbInsert(lat, lnt);
    }
